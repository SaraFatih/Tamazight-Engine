...
public class Parsing {
	...
	public  List<String> funct(String myChar,String myPos) {
		...
		try {
			...
			if(myPos.equals("b")){
				...
				Pattern p = Pattern.compile(myChar +"\\w+");
			...
			else if(myPos.equals("m")){
				Pattern p = Pattern.compile("\\w+"+ myChar +"\\w+");
				Matcher m = p.matcher(after);
				while(m.find()){
				System.out.println(m.group());
			...
			else if(myPos.equals("e")){
				Pattern p = Pattern.compile("\\w+"+ myChar);
				Matcher m = p.matcher(after);
				while(m.find()){
									System.out.println(m.group());
